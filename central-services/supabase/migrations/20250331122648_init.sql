...
grant delete on table "public"."report_requests" to "postgres";

grant insert on table "public"."report_requests" to "postgres";

grant references on table "public"."report_requests" to "postgres";

grant
select
    on table "public"."report_requests" to "postgres";

grant trigger on table "public"."report_requests" to "postgres";

grant truncate on table "public"."report_requests" to "postgres";

grant
update on table "public"."report_requests" to "postgres";
